  ...
  <div class="min-h-screen bg-brand-bg flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-300">
    ...
    <div class="relative z-10 w-full max-w-md select-none">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-text-secondary text-sm mt-1 font-semibold uppercase tracking-wider font-mono">AI Logistics Operations Hub</p>
      </div>
      ...
      <div class="glass-card rounded-3xl p-8 shadow-xl bg-card-bg border border-brand-border/60">
        <div class="flex items-center gap-2 mb-6 border-b border-brand-border pb-3.5">
          ...
          <h2 class="text-text-primary font-bold text-sm uppercase tracking-widest font-mono">Gateway Access</h2>
        </div>

        <form @submit.prevent="handleLogin" class="space-y-4" id="login-form">
          <!-- Username Input -->
          <div>
            <label for="login-username" class="block text-sm font-black text-text-secondary mb-1.5 uppercase tracking-wider font-mono">
              Username
            </label>
            <input
              id="login-username"
              ...
              class="glass-input px-4 py-3 text-sm w-full font-semibold focus:outline-none"
            />
          </div>

          <!-- Password Input -->
          <div>
            <label for="login-password" class="block text-sm font-black text-text-secondary mb-1.5 uppercase tracking-wider font-mono">
              Password
            </label>
            <div class="relative">
              <input
                ...
                required
                :disabled="authStore.loading"
                class="glass-input px-4 py-3 pr-11 text-sm w-full font-semibold focus:outline-none"
              />
              <button
                type="button"
          ...
          <transition name="slide-down">
            <div v-if="authStore.error" 
                 class="flex items-start gap-2.5 text-sm text-rose-500 bg-rose-500/10 border border-rose-500/20 rounded-xl px-3 py-2.5 font-medium leading-normal animate-in slide-in-from-top-2 duration-150">
          ...
          <button
            ...
            class="w-full flex items-center justify-center gap-2 py-3 rounded-full font-bold text-sm uppercase tracking-wider
        ...
        <div class="mt-6 pt-5 border-t border-brand-border/60">
          <p class="text-center text-sm text-text-secondary/70 font-mono">
      ...
      <!-- Footer Info -->
      <p class="text-center text-sm font-black uppercase tracking-wider text-text-secondary/60 mt-6 font-mono">
